...
<tr>
<td><input class="input_field_middle_4" type="button" value="Add another Row" id="input_button_row"" onClick="window.location.href='add_location_row.php'"></td>
</tr>
<tr>
<td><input type="button" value="Continue" id="accept_button" class="input_button" onClick="window.location.href='add_location_finish.php'"></a>
