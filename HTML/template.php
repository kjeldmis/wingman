...
<tr>
<td><input type="text" name="" class="input_field_1" placeholder=""></td>
</tr>
<tr>
<td><select name="" size="1" class="input_field_2">
    <option selected="selected" value=""></option>
    <option value="a"></option>
    </select></td>
</tr>
<tr>
    <td><select name="" size="1" class="input_field_3">
    <option selected="selected" value=""></option>
    <option value="a"></option>
    </select></td>
</tr>
<tr>
    <td><select name="" size="1" class="input_field_4">
    <option selected="selected" value=""></option>
    <option value="a"></option>
    </select></td>
</tr>
<tr>
<td><input type="button" value="Save and Finish" id="accept_button" class="input_button" onClick="window.location.href=''"></a>
    <input type="button" value="Cancel" id="cancel_button" class="input_button" onClick="window.location.href=''"></a></td>
</tr>
</form>
</table>
    </div>
...
<form name="_form" method="post" action="">
<tr>
<td><input type="text" name="" class="input_field2_1" placeholder=""></td>
</tr>
<tr>
<td><select name="" size="1" class="input_field2_2">
    <option selected="selected" value=""></option>
    <option value="a"></option>
    </select></td>
</tr>
<tr>
    <td><select name="" size="1" class="input_field2_3">
    <option selected="selected" value=""></option>
    <option value="a"></option>
    </select></td>
</tr>
<tr>
    <td><select name="" size="1" class="input_field2_4">
    <option selected="selected" value=""></option>
    <option value="a"></option>
    </select></td>
</tr>
<tr>
    <td><input type="time" name="time" class="input_field2_5"></td>
</tr>
<tr>
