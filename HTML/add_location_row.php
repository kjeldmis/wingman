...
<tr>
<td class="input_field_1">"" created succesfully</td>
</tr>
<tr>
<td><input type="text" name="row" id="row_field" class="input_field_middle_2" placeholder="Row Number" required="required"></td>
</tr>
<tr>
<td><input type="text" name="space" id="row_field" class="input_field_middle_4" placeholder="Number of spaces" required="required"></td>
</tr>
<tr>
<td><input type="hidden" name="name" class="input_field_6" value=""></td>
</tr>
<tr>
<td><input type="button" value="Save Row" id="accept_button" class="input_button" onClick="window.location.href='add_location_row_finish.php'"></a>
