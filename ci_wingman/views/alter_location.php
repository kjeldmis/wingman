...
<html>
    ...
    <body>
        ...
        <header>
            ...
            <input type="button" value="Back" id="back_button" class="header_button" onClick="window.location.href='alter_show_location.php'"></a>
        ...
        <div class="data_area">
            <table class="data_table" border="1" cellpadding="6">
                ...
                <tr>
                    <td>12</td>
                    <td><input type="button" value="Select" onClick="window.location.href='alter_location_row.php'"></a></td>
                </tr>
            </table>
        </div>
