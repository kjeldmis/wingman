...
<html>
    ...
    <body>
        ...
        <div class="mainmenu_content">
            ...
            <input type="button" value="Create Blade" id="button_1" class="mainmenu_button" onClick="window.location.href='create_blade.php'"></a>
            <input type="button" value="Search Blade" id="button_2" class="mainmenu_button" onClick="window.location.href='search_blade.php'"></a>
            <input type="button" value="Delete Blade" id="button_3" class="mainmenu_button" onClick="window.location.href='delete_blade.php'"></a>
