...
<html>
    <head>
        <title>Wingman - Deactivate User</title>
    ...
    <body>
        ...
        <div class="mainmenu_content">
            <input type="button" value="Deactivate User" id="button_1" class="highlighted_mainmenu_button"></a>
        </div>
        ...
        <div class="input_area">
            <table class="updateDB_form">
                <form name="addlocation_form" method="post" action="">
                    ...
                    <tr>
                        <td>
                            <input type="button" value="Yes" id="accept_button" class="input_button" onClick="window.location.href='user_menu.php'"></a>
                            <input type="button" value="No" id="cancel_button" class="input_button" onClick="window.location.href='user_menu.php'"></a>
                        </td>
                    </tr>
                </form>
            </table>
