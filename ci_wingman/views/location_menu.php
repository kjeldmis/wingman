...
<html>
    ...
    <body>
        ...
        <div class="mainmenu_content">
            ...
            <input type="button" value="Create Location" id="button_1" class="mainmenu_button" onClick="window.location.href='add_location.php'"></a>
            <input type="button" value="Alter Location" id="button_2" class="mainmenu_button" onClick="window.location.href='alter_show_location.php'"></a>
            <input type="button" value="Delete Location" id="button_3" class="mainmenu_button" onClick="window.location.href='delete_location.php'"></a>
