...
<html>
    ...
    <body>
        ...
        <div class="mainmenu_content">
            ...
            <div id="button_1">
                <input type="button" value="Create Location" id="addlocation_button" class="mainmenu_button" onClick="window.location.href='<?php echo base_url('index.php/location/add_location');?>'"></a>
            </div>
            <div id="button_2">
