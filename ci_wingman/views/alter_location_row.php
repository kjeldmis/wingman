...
<html>
    <head>
        <title>Wingman - Alter Location</title>
    ...
    <body>
        ...
        <header>
            ...
            <input type="button" value="Back" id="back_button" class="header_button" onClick="window.location.href='alter_location.php'"></a>
        ...
        <div class="mainmenu_content">
            <input type="button" value="Alter Location" id="button_1" class="highlighted_mainmenu_button"></a>
        </div>
        ...
        <div class="data_area">
            <table class="data_table" border="1" cellpadding="6">
                ...
                <tr>
                    <td>23</td>
                    <td>5B1243900</td>
                    <td><input type="button" value="Move" onClick="window.location.href='location_menu.php'"></a></td>
                    <td><input type="button" value="Delete" onClick="window.location.href='location_menu.php'"></a></td>
                </tr>
            </table>
        </div>
