...
<div id="button_3">
    <input type="button" value="Admin. Options" id="adminoptions_button" class="mainmenu_button" onClick="window.location.href='<?php echo base_url('index.php/main/admin_options');?>'"></a>
</div>
<div id="button_4">
