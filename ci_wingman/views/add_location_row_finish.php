        ...
        <div class="input_area">
            <table class="updateDB_form">
                <form name="addlocation_form" method="post" action="">
                    ...
                    <tr>
                        <td>
                            <input type="button" value="Continue" id="accept_button" class="input_button" onClick="window.location.href='<?php echo base_url('index.php/location/add_location_finish');?>'"></a>
