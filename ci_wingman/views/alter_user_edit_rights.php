...
<html>
    ...
    <body>
        ...
        <header>
            ...
            <input type="button" value="Back" id="back_button" class="header_button" onClick="window.location.href='alter_user_edit.php'"></a>
        ...
        <div class="input_area">
            <table class="updateDB_form">
                <form name="user_rights_form" method="post" action="">
                    ...
                    <tr>
                        <td>
                            <input type="button" value="Save" id="accept_button" class="input_button" onClick="window.location.href='alter_user_edit.php'"></a>
                            <input type="button" value="Cancel" id="cancel_button" class="input_button" onClick="window.location.href='alter_user_edit.php'"></a>
                        </td>
                    </tr>
                </form>
            </table>
